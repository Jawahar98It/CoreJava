...
public class Inmakes_challenge2 
{
	...
	for (Entry<Integer, String> entry : ent) 
	{
		...
		//Challenge 32 is linked with Challenge 20
		System.out.println("Challenge 32 & Challenge 38");
		...
		//Challenge 33 is linked with Challenge 21
		System.out.println("Challenge 33");
		...
		//Challenge 34 is linked with Challenge 22
		...
		//Challenge 35 is linked with Challenge 19
		...
		System.out.println("Challenge 37");
		
		Set<Entry<Integer, Integer>>ent1=mp1.entrySet();
		System.out.println(ent1);
		
	for (Entry<Integer, Integer> entrydata : ent1) 
	{
		Integer entryKey1 =entrydata.getKey();
		System.out.println("Keys:"+entryKey1);
		Integer entryValue1=entrydata.getValue();
		System.out.println("Values: "+entryValue1);
	}
